...
export function MultiSelectTrigger({
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        "group relative z-20 flex min-h-11 w-full min-w-52 cursor-text items-center gap-2 rounded-xl border border-border bg-transparent px-2.5 py-1.5 text-sm text-foreground transition-[border-color] hover:border-(--color-border-strong)",
